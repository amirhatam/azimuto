                                ...
                                return <>
                                    <MDBCol lg="4" md="12" className=" my-5 mx-0 px-0" >
                                        ...
                                        <div className="text-center">
                                            <a href={`http://localhost:8080/uploads/${e.pdf}`}   target="_blank" rel="noreferrer">
                                                <i data-test="fa" className="fa fa-file-pdf pr-2 h1"></i>
                                            </a>
                                            <h5   className="my-3 fontW">
                                                {e.description}
                                            </h5>
                                            <MDBRow center className="my-5">
                                                <MDBCol className="px-0" size="4">
                                                    <MDBBtn size="sm"  color='amber' className="btn-rounded btn-1 my-3 px-3" onClick={(elem) => { setEditingId(e._id); setViews("Edit") }}  >Editer</MDBBtn >
                                                </MDBCol>
                                                <MDBCol className="px-0" size="4">
                                                    <MDBBtn size="sm"  color='amber' className="btn-rounded btn-1 my-3 px-3" onClick={(elem) => { setDeleteId(e._id); setViews("Delete") }} >Effacer</MDBBtn >
                                                </MDBCol>
                                            </MDBRow>
                                        </div>
