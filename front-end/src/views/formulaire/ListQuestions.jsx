                            ...
                            <MDBCol className="my-5" md='4' >
                                ...
                                <h4 className='card-title mt-5 px-5'  style={{ height: "10vmax" }}>{elem.description}</h4>
                                    ...
                                    <div className="text-center my-2">
                                        <MDBBtn size="sm"  color='amber' className="btn-rounded btn-1" onClick={(e) => { props.setEditingId(elem._id); props.setViews("Edit") }}>Editer</MDBBtn >
                                        <MDBBtn size="sm"  color='amber' className="btn-rounded btn-1" onClick={(e) => { props.setDeletId(elem._id); props.setViews("Delete") }}>Effacer</MDBBtn >
                                    </div>
                                </MDBCard>
                            </MDBCol>
                        </>
